...
export class RouteScheduleService {
  ...
  async create(createRouteScheduleDto: Prisma.RouteScheduleCreateInput & RouteSchedule) {
  ...
  async findAll(params: any) {
    const { skip, take, where, pageNum } = buildPageQuery(params, ['schedule_id', 'route_id']);
  ...
  async update(id: number, updateRouteScheduleDto: Prisma.RouteScheduleUpdateInput & RouteSchedule) {
