...
// import { JobList, createJobListApi, getAllStationApi } from '../../../apis/station';
...
import { JobList, createJobListApi, getAllJobListApi } from '../../../apis/employee/jobList';
// import { JobList, createJobListApi, getAllJobListApi } from '../../../apis/vehicle/vehicle';

export default function InfoTable() {
  const refreshTable = useSelector((state: RootState) => state.common.refreshTable);
  const [selections, setSelections] = useState<number[]>()
  const navigate = useNavigate();
  const getData = getDataFnFactory<JobList[]>(navigate, getAllJobListApi, 'job_id')

  const dispatch = useDispatch();
  const onSubmit = async (values: JobList) => {
    const result = await createJobListApi(values)
    if (result?.data) {
