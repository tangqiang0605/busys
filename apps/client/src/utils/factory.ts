...
// TODO 完善类型注释
export const getDataFnFactory = (navigate: any, fn: (query: any & { pageNum?: number, pageSize?: number }) => Promise<Response<{ total: number, pageNum: number, pageSize: number, data: any[] }>>) => {
